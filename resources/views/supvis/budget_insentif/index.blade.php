<x-Supvis.SupvisLayouts>
        ...
        <div class="card p-4 shadow-sm">
            ...
            <form action="{{ route('supvis.budget_insentif.update') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="total_insentif_display" placeholder="Rp 0">

                    <input type="hidden" name="total_insentif" id="total_insentif">
                </div>
    ...
    <script>
        const inputDisplay = document.getElementById('total_insentif_display');
        const inputReal = document.getElementById('total_insentif');
